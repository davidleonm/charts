...
```bash
helm install plex /mnt/helms/plex-1.0.0.tgz --namespace=default --set spec.volumes.configPath=/mnt/config --set spec.volumes.transcodingPath=/mnt/transcode --set spec.volumes.libraryPath=/mnt/library
```
